...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FootballPool.progress_qnl'
        db.add_column('footballpools_footballpool', 'progress_qnl',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FootballPool.progress_qnl'
        db.delete_column('footballpools_footballpool', 'progress_qnl')
    ...
    models = {
        'footballpools.footballpool': {
            ...
            'order_qnl': ('django.db.models.fields.CharField', [], {'max_length': '200', 'default': "''"}),
            'progress_qnl': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
