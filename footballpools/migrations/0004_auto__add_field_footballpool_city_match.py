...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FootballPool.city_match'
        db.add_column('footballpools_footballpool', 'city_match',
                      self.gf('django.db.models.fields.CharField')(max_length=200, default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FootballPool.city_match'
        db.delete_column('footballpools_footballpool', 'city_match')
