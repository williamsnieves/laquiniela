...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FootballPool.order_qnl'
        db.add_column('footballpools_footballpool', 'order_qnl',
                      self.gf('django.db.models.fields.CharField')(max_length=200, default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FootballPool.order_qnl'
        db.delete_column('footballpools_footballpool', 'order_qnl')
