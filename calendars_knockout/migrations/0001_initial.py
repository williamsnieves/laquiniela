...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CalendarKnockout'
        db.create_table('calendars_knockout_calendarknockout', (
        ...
        db.send_create_signal('calendars_knockout', ['CalendarKnockout'])


    def backwards(self, orm):
        # Deleting model 'CalendarKnockout'
        db.delete_table('calendars_knockout_calendarknockout')


    models = {
        'calendars_knockout.calendarknockout': {
            'Meta': {'object_name': 'CalendarKnockout'},
    ...
    complete_apps = ['calendars_knockout']