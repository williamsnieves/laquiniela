...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Calendar.order_match'
        db.add_column('calendars_calendar', 'order_match',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Calendar.order_match'
        db.delete_column('calendars_calendar', 'order_match')
    ...
    models = {
        'calendars.calendar': {
            ...
            'order_match': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
