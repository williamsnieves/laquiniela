...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CalendarSemifinal'
        db.create_table('calendars_semifinal_calendarsemifinal', (
        ...
        db.send_create_signal('calendars_semifinal', ['CalendarSemifinal'])


    def backwards(self, orm):
        # Deleting model 'CalendarSemifinal'
        db.delete_table('calendars_semifinal_calendarsemifinal')


    models = {
        'calendars_semifinal.calendarsemifinal': {
            'Meta': {'object_name': 'CalendarSemifinal'},
    ...
    complete_apps = ['calendars_semifinal']